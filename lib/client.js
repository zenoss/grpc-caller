...
function promisifyClientProto (targetProto, clientProto) {
  ...
  _.forOwn(clientProto, (v, k) => {
    ...
    if (typeof clientProto[k] === 'function') {
      // Look at __original function for when grpc instrumentation is setup.
      const requestStream = v.__original ? v.__original.requestStream : v.requestStream
      const responseStream = v.__original ? v.__original.responseStream : v.responseStream
